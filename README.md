...
Tech Squad Manager é um Jogo Educativo do gênero simulação/gerenciamento, focado no ensino de carreiras em Tecnologia da Informação.

O projeto foi concebido para atender alunos do Ensino Médio Técnico em Informática , com o objetivo de desmistificar o mercado de trabalho e apresentar, de forma lúdica, que a área de TI vai muito além da programação básica.
